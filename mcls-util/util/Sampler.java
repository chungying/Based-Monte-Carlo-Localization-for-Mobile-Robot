...
public class Sampler {
	...
	/**
	 * This main is showing the histogram of a distribution.
	 * @param args
	 * @throws Exception
	 */
...
//		List<Float> splitKeys = new ArrayList<Float>();
		...
		laser.range_min = 0f;
		laser.range_max = -1;
		Grid g = new Grid(/*orientation, orientation/2+1, -1,*/ imagePath);
		g.laser.setupSensor(laser);
		sampling(map, g, samples);
